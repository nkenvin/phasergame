...
export default class OptionsScene extends Phaser.Scene {
  ...
  preload() {
    this.load.image('staticBackground', '/static/corona_up.png');
  }
  ...
  create() {
    ...
    this.text = this.add.text(300, 100, 'Settings', { fontSize: 48 });
    ...
    this.menuButton = new ButtonGen(this, 400, 500, 'menuButton', 'menuButtonFocus', 'Title', 'btnSelect');
