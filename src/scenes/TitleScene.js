...
export default class TitleScene extends Phaser.Scene {
  ...
  create() {
    ...
    // Options button
    this.optionsButton = new ButtonGen(this, config.width / 2, config.height / 2 + 120, 'optionsButton', 'optionsButtonFocus', 'Options', this.sfx.btnSelect);

    // Credits button
    this.creditsButton = new ButtonGen(this, config.width / 2, config.height / 2 + 200, 'creditsButton', 'creditsButtonFocus', 'Credits', this.sfx.btnSelect);

    // Highscores Button
    this.highscoresButton = new ButtonGen(this, config.width / 2, config.height / 2 + 280, 'highscoresButton', 'highscoresButtonFocus', 'HighscoresScene', this.sfx.btnSelect);
    ...
    this.add.image(400, 210, 'titleScreen');
  }
