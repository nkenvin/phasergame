...
export default class HighscoresScene extends Phaser.Scene {
  ...
  create() {
    ...
    const highScoreText = this.add.text(config.width / 2, config.height / 2, 'Best Score: ', {
      font: '56px Arial',
      color: '#00FF33',
      align: 'center',
      lineHeight: '1.5',
    ...
    this.mainMenuButton = new ButtonGen(this, config.width / 2, config.height / 2 + 300, 'mainMenuButton', 'mainMenuButtonFocus', 'Title', this.sfx.btnSelect);
