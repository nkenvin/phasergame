...
export default class GameOverScene extends Phaser.Scene {
  ...
  create() {
    ...
    // Game Button
    this.gameButton = new ButtonGen(this, config.width / 2, config.height / 2 + 50, 'restartButton', 'restartButtonFocus', 'Game', this.sfx.gameStart);

    // Options button
    this.optionsButton = new ButtonGen(this, config.width / 2, config.height / 2 + 130, 'optionsButton', 'optionsButtonFocus', 'Options', this.sfx.btnSelect);

    // Credits button
    this.creditsButton = new ButtonGen(this, config.width / 2, config.height / 2 + 210, 'creditsButton', 'creditsButtonFocus', 'Credits', this.sfx.btnSelect);

    // Main Menu button
    this.mainMenuButton = new ButtonGen(this, config.width / 2, config.height / 2 + 290, 'mainMenuButton', 'mainMenuButtonFocus', 'Title', this.sfx.btnSelect);
